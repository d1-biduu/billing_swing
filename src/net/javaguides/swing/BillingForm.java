...
textField.requestFocus();
		...
		panel_1.setBounds(781, 43, 240, 167);
		...
		btnNewButton_1.setBounds(25, 280, 85, 21);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int row= table.getSelectedRow();
				Object ProductCode=tableModel.getValueAt(row, 0);
			int status=	JOptionPane.showConfirmDialog(BillingForm.this, "Click YES to Confirm","Do you really want to delete this data?", JOptionPane.YES_NO_OPTION);
			if(status==0) {
...
//			sum = sum + Integer.parseInt(tableModel.getValueAt())
//		});
//		}
